...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force NASIC_monitor_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file NASIC_monitor_drc_opted.rpt -pb NASIC_monitor_drc_opted.pb -rpx NASIC_monitor_drc_opted.rpx"
...
set rc [catch {
  ...
  create_report "impl_1_place_report_utilization_0" "report_utilization -file NASIC_monitor_utilization_placed.rpt -pb NASIC_monitor_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file NASIC_monitor_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force NASIC_monitor_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file NASIC_monitor_drc_routed.rpt -pb NASIC_monitor_drc_routed.pb -rpx NASIC_monitor_drc_routed.rpx"
...
if {$rc} {
  write_checkpoint -force NASIC_monitor_routed_error.dcp
...
set rc [catch {
  ...
  catch { write_mem_info -force NASIC_monitor.mmi }
  write_bitstream -force NASIC_monitor.bit 
  catch {write_debug_probes -quiet -force NASIC_monitor}
  catch {file copy -force NASIC_monitor.ltx debug_nets.ltx}
