...
HD_PWD='D:/Universidad/Repositorios/GitHub/Doctorado/NASIC/NASIC/Characterization/Hardware/HDL/Project_ZTEX/Monitor_NASIC/Monitor_NASIC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NASIC_monitor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NASIC_monitor.tcl -notrace
