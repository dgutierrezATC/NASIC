...
HD_PWD='D:/Universidad/Repositorios/GitHub/Doctorado/NASIC/NASIC/Characterization/Hardware/HDL/Project_ZTEX/Monitor_NASIC/Monitor_NASIC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NASIC_monitor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NASIC_monitor.tcl
